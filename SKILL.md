# Foresight Engine — Claude.ai Skill
> **This skill is for [claude.ai](https://claude.ai) (web).** For Claude Desktop → [MCP Server](https://github.com/isanthoshgandhi/foresight-engine) · For Claude Code → [Plugin](https://github.com/isanthoshgandhi/foresight-engine-plugin)
